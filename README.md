...
Supported environment variable files and their usage:

| File | Environment | Accessible From |
|------|-------------|-----------------|
...
| `wrangler.jsonc` vars | Cloudflare Workers | Server only |

See `src/lib/env.example.ts` for more usage and API reference.
